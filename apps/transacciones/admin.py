...
class VentaAdmin(admin.ModelAdmin):
    list_display = ('cliente', 'empleado', 'fecha', 'tipo', 'metodo_pago', 'estatus', 'total', 'origen', 'activo')
    search_fields = ('cliente__nombre', 'empleado__nombre', 'folio')
    list_filter = ('estatus', 'tipo', 'metodo_pago', 'fecha', 'origen', 'activo')
